---
layout: post
title: "Dart Stream 流式编程深度解析：数据管道、背压与响应式开发的正确姿势"
description: >
  Stream 是 Dart 响应式编程的管道：讲清单订阅/广播流、listen、await for、背压（Backpressure）与 StreamBuilder。
  掌握后能答出「Stream 和 Future 的区别及背压怎么处理」。
date: 2026-05-03
