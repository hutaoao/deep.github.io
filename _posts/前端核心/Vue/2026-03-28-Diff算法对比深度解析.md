---
layout: post
title: "Diff算法对比：Vue3 vs React 深度解析"
description: >
  Vue3 Diff 是双端比较四指针夹击，优先匹配头头尾尾头尾尾头；React Diff 是单向遍历 Fiber 链表，key 匹配复用不匹配跳出。
  Vue 双端在列表反转场景占优，React 简洁换来可维护性与 Fiber 兼容，面试常考两者策略差异与各自适用场景。
date: 2026-03-28
categories: ["前端核心", "Vue"]
