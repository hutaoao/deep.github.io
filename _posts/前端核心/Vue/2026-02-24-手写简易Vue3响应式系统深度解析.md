---
layout: post
title: "手写简易 Vue3 响应式系统深度解析"
description: >
  手写 Vue3 响应式的 reactive、effect、computed、ref、watch 五个核心模块加起来不到一百行，却是理解框架的终极钥匙。
  面试手写不考记忆力，考的是否理解 WeakMap 三层数据结构的设计意图与 cleanup 清理依赖的必要性。
date: 2026-02-24
categories: ["前端核心", "Vue"]
