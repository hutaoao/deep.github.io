---
layout: post
title: "Pinia状态管理原理深度解析"
description: >
  Pinia 是 Vue3 官方状态管理库，本质是用 Composition API 把全局 reactive/ref 包装成 store，去掉了 Vuex 的 Mutation 与 Module 嵌套。
  靠 Proxy 响应式加 TS 类型推导，让状态管理退回到写一个全局组合式函数，面试常考它与 Vuex 的差异和为什么更轻量。
date: 2026-03-03
